...
@section('breadcrumbs', Breadcrumbs::render('admin.empresas.adminedit', $usuario, $empresa))
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    {!! Form::model($empresa,['route' => ['admin.empresas.adminupdate', 'id' => $empresa->id],'class' => 'form', 'method' => 'PUT', 'enctype'=>'multipart/form-data']) !!}
...
<script type="text/javascript">
    ...
    function initMap() {
        ...
        @if($empresa->latitude!="")
            myLatLng = new google.maps.LatLng({{$empresa->latitude}}, {{$empresa->longitude}});
            addMarker(myLatLng);
