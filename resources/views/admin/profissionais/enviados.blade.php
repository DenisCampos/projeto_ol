...
@section('page_name', 'Profissionais Enviados')

@section('breadcrumbs', Breadcrumbs::render('admin.profissionais.enviados'))
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-title">
                            <h3 class="text-center">Perfil Profissional Enviados</h3>
                        </div>
                        <hr>
