...
@section('breadcrumbs', Breadcrumbs::render('admin.cursos.usercursos', $usuario))
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Infoprodutos do usuário</strong>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><button type="button" class="btn btn-info" onclick="window.location='{{ route("admin.cursos.adminshow", [$usuario->id, $curso->id]) }}'"><i class="fa fa-file-text-o"></i> Detalhar</button></td>
                                </tr>
                                @php
                                    $cont++;
                                @endphp
