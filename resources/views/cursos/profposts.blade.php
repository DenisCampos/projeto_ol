...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12" role="group">
            <button type="button" class="mb-1 btn btn-outline-custom @if($categoria=='todos') active @endif" onclick="window.open('{{route('cursos.profposts',['categoria'=>'todos'])}}','_self')">
                Todos
            </button>
            @foreach($opcoescategorias as $opcoescategoria)
            <button type="button" class="mb-1 btn btn-outline-custom @if($opcoescategoria->slug==$categoria) active @endif" onclick="window.open('{{route('cursos.profposts',['categoria'=>$opcoescategoria->slug])}}','_self')">
