...
@section('page_name', 'Profissionais Aprovados')

@section('breadcrumbs', Breadcrumbs::render('admin.profissionais.aprovados'))
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-title">
                            <h3 class="text-center">Perfil Profissional Aprovados</h3>
                        </div>
                        <hr>
