...
@section('assets_meta')
    <meta property='og:title' content='{{$profissional->name}}' />
    <meta property='og:description' content='{{$profissional->descricao}}' />
    <meta property='og:image' itemprop="image" content='{{ asset($profissional->foto) }}' />
    ...
    <meta name='twitter:title' content='{{$profissional->name}}' />
    <meta name='twitter:description' content='{{$profissional->descricao}}' />
    <meta name='twitter:image:src' content='{{ asset($profissional->foto) }}' />
@endsection
...
@section('descricao')
    Parceiro OloyFit: {{$profissional->name}}
@endsection
