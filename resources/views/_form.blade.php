...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="mx-auto d-block text-center">
            @if($usuario->foto=="")
                <img class="align-self-center rounded-circle mr-3" src="{{ asset('public/images/100x100.jpg') }}" style="width:100px; height:100px;"  alt="Card image cap">
            @else
                <img class="align-self-center rounded-circle mr-3" src="{{ asset($usuario->foto) }}" style="width:100px; height:100px;"  alt="Card image cap">
            @endif
            <hr>
