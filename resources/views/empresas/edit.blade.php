...
@section('breadcrumbs', Breadcrumbs::render('empresas.edit', $empresa))
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    {!! Form::model($empresa,['route' => ['empresas.update', 'id' => $empresa->id],'class' => 'form', 'method' => 'PUT', 'enctype'=>'multipart/form-data']) !!}
