            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn btn-primary btn-block" onclick="window.open('{{route('eventos.index')}}', '_self')">Finalizar</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function selecionar_categoria(categoria, evento) {
        ...
        if (classe == 'fa fa-toggle-on fa-2x'){
            ...
            acao = "{{route('eventocategorias.destroy')}}";
        }else{
            ...
            acao = "{{route('eventocategorias.store')}}";
        }
