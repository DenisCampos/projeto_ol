...
@section('breadcrumbs', Breadcrumbs::render('admin.categorias.edit', $categoria))
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    {!! Form::model($categoria,['route' => ['admin.categorias.update', 'id' => $categoria->id],'class' => 'form', 'method' => 'PUT', 'enctype'=>'multipart/form-data']) !!}
                    <div class="card-body">
