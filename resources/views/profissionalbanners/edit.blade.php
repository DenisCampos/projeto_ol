        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li <a href="{{ route("profissionalbanners.index", ['profissional' => $banner->profissional_id])}}">Banner</a></li>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    ...
                    {!! Form::model($banner,['route' => ['profissionalbanners.update', 'profissional' => $banner->profissional_id , 'id' => $banner->id],'class' => 'form', 'method' => 'PUT', 'enctype'=>'multipart/form-data']) !!}
                    <div class="card-body">
