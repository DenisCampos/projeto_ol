...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12" role="group">
            <button type="button" class="mb-1 btn btn-outline-custom @if($categoria==0) active @endif" onclick="window.open('{{route('cursos.empposts',['categoria'=>0])}}','_self')">
                Todos
            </button>
            @foreach($opcoescategorias as $opcoescategoria)
            <button type="button" class="mb-1 btn btn-outline-custom @if($opcoescategoria->id==$categoria) active @endif" onclick="window.open('{{route('cursos.empposts',['categoria'=>$opcoescategoria->id])}}','_self')">
