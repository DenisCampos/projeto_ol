...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12" role="group">
            <button type="button" class="mb-1 btn btn-outline-subcustom @if($subatuacao=='todos') active @endif" onclick="window.open('{{route('profissionais.subposts',['atuacao'=>$atuacao,'subatuacao'=>'todos'])}}','_self')">
                Todos
            </button>
            @foreach($opcoessubatuacoes as $opcoessubatuacao)
            <button type="button" class="mb-1 btn btn-outline-subcustom @if($opcoessubatuacao->slug==$subatuacao) active @endif" onclick="window.open('{{route('profissionais.subposts',['atuacao'=>$atuacao,'subatuacao'=>$opcoessubatuacao->slug])}}','_self')">
