...
@section('page_name', 'Interesses')

@section('breadcrumbs', Breadcrumbs::render('userinteresses.index'))
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn btn-primary btn-block" onclick="window.open('{{route('home')}}', '_self')">Finalizar</button>
                    </div>
                </div>
            </div>
        </div>
